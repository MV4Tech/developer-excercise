...
const ScanNoDiscountComponentModal = () => {
    ...
    const handleSubmit = async () => {
      try {
        const response = await ProductService.scanWithoutDiscount(products);
  ...
  return (
    <div>
      ...
      <Modal show={showPriceModal} onHide={handleClosePriceModal}>
        <Modal.Header closeButton>
          <Modal.Title>Final Price</Modal.Title>
        </Modal.Header>
        <Modal.Body>
...
export default ScanNoDiscountComponentModal