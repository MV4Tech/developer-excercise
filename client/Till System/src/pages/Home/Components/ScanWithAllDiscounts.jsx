...
const ScanWithAllDiscounts = () => {
    ...
    const handleSubmit = async () => {
      try {
        const response = await ProductService.scanWithAllDiscounts(products);
  ...
  return (
    <div>
      ...
      <button
        ...
        className="custom-button-all-discounts"
      >
        All Current Discounts
      </button>
          ...
          <div className="mt-3">
            ...
            <ul>
              {products.map((product, index) => (
                <li
                  key={index}
                >{`${product.name}: ${product.cloud} clouds`}</li>
              ))}
            </ul>
          </div>
        </Modal.Body>
      ...
      <Modal show={showPriceModal} onHide={handleClosePriceModal}>
        <Modal.Header closeButton>
          <Modal.Title>
            Final Price With All Current Discount
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
...
export default ScanWithAllDiscounts;
