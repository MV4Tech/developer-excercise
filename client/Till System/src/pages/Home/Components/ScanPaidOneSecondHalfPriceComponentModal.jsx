...
const ScanPaidOneSecondHalfPriceComponentModal = () => {
    ...
    const handleSubmit = async () => {
      try {
        const response = await ProductService.scanPaidOneSecondHalfPrice(products);
  ...
  return (
    <div>
         ...
         <button onClick={() => setLgShow(true)} className="custom-button-1-second-50-off">Paid One second 50% OFF</button>
     ...
     >
       <Modal.Header closeButton>
         <Modal.Title id='example-modal-sizes-title-lg'>Scan with one paid second 50% OFF</Modal.Title>
       </Modal.Header>
       <Modal.Body>
         <Form>
     ...
     <Modal show={showPriceModal} onHide={handleClosePriceModal}>
       <Modal.Header closeButton>
         <Modal.Title>Final Price With Paid 1 Second 50% OFF Discount</Modal.Title>
       </Modal.Header>
       <Modal.Body>
...
export default ScanPaidOneSecondHalfPriceComponentModal